...
/* describe("GET /api/v1/getRiskProfileQuestions", () => {
    ...
    test("Should respond with a 200 status code", async () => {
      const response = await request(server).get("/api/v1/getRiskProfileQuestions");
...
/* describe("GET /api/v1/getAnswersRiskQuestions", () => {
    //Testing ok status code
    test("Should respond with a 200 status code", async () => {
      const response = await request(server).get("/api/v1/getAnswersRiskQuestions");
...
/* describe("GET /api/v1/getRiskProfileQuestionSelection", () => {
    //Testing ok status code
    test("Should respond with a 200 status code", async () => {
      const response = await request(server).get("/api/v1/getRiskProfileQuestionSelection");
...
/* describe("GET /api/v1/getRiskProfile", () => {
    //Testing ok status code
    test("Should respond with a 200 status code", async () => {
      const response = await request(server).get("/api/v1/getRiskProfile");
...
describe("GET /api/v1/getScales", () => {
    //Testing ok status code
    test("Should respond with a 200 status code", async () => {
      const response = await request(server).get("/api/v1/getScales");
...
/* describe("GET /api/v1/postRiskProfileForAccount", () => {
    //Testing ok status code
    test("Should respond with a 200 status code", async () => {
      const response = await request(server).get("/api/v1/postRiskProfileForAccount");
...
/* describe("GET /api/v1/postRiskProfileQuestionSelection", () => {
    //Testing ok status code
    test("Should respond with a 200 status code", async () => {
      const response = await request(server).get("/api/v1/postRiskProfileQuestionSelection");
...
/* describe("GET /api/v1/UpdateRiskProfileScale", () => {
    //Testing ok status code
    test("Should respond with a 200 status code", async () => {
      const response = await request(server).get("/api/v1/UpdateRiskProfileScale");
